...
describe TranslatorAPI::Translator do
  ...
  it 'Incorrect reduction' do
    translator = TranslatorAPI::Translator.new('trnsl.1.1.20151124T095711Z.d41f13a82e427408.736db2b43c90575b5934e1b988554b94947240e1',"Incorrect reduction")
    expect(translator).to be_instance_of NilClass  
  end
  
  it 'Invalid key' do
    translator = TranslatorAPI::Translator.new('Invalid key')
    expect(translator).to be_instance_of NilClass  
  end
  
  before :each do
      @translator = TranslatorAPI::Translator.new 'trnsl.1.1.20151124T095711Z.d41f13a82e427408.736db2b43c90575b5934e1b988554b94947240e1'      
  end 
